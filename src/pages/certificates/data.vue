<template>
    ...
    <i-paginatable-page
        ...
        :thead="[
            '交易哈希值', '业务类型', '业务 ID', '加密类型', '交易时间', '签名用户', '存证证书'
        ]"
        disabled-paginator>
        <template #caption>
            <p
...
import StoreDialog from '~/prefabs/certificates/data/store-dialog.vue';
import IButton from '~ui/components/button/component.vue';
import PlusIcon from '~/components/icons/plus.vue';
import DataTr from '~/prefabs/certificates/data/tr.vue';
</script>
